...
const SwapDetail = ({label, value}) => (
  <div className="flex justify-between items-center p-4 bg-gray-50 dark:bg-black rounded-xl">
...
const ActionButtons = ({onBack, onConfirm}) => (
  <div className="flex space-x-3">
    <button
      onClick={onBack}
      className="flex-1 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 py-3 rounded-xl font-semibold transition-colors duration-200 hover:bg-gray-50 dark:hover:bg-gray-800">
      Back
    </button>
    <button onClick={onConfirm} className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl font-semibold transition-colors duration-200">
      Generate Proof
    </button>
  </div>
);
