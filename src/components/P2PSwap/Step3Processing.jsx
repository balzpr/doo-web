...
const LoadingSpinner = () => <div className="w-20 h-20 border-4 border-blue-600 border-t-transparent rounded-full animate-spin mx-auto mb-6"></div>;
...
const ProofStatus = ({label, isComplete, statusText}) => (
  <div
    className={`p-4 rounded-xl border-2 transition-all duration-500 ${
      isComplete ? "bg-green-50 dark:bg-green-900/20 border-green-300 dark:border-green-700" : "bg-gray-50 dark:bg-gray-800 border-gray-300 dark:border-gray-700"
    }`}>
...
const TokenBurnStatus = ({isComplete, statusText}) => (
  <div
    className={`p-4 rounded-xl border-2 transition-all duration-500 ${
      isComplete ? "bg-orange-50 dark:bg-orange-900/20 border-orange-300 dark:border-orange-700" : "bg-gray-50 dark:bg-gray-800 border-gray-300 dark:border-gray-700"
    }`}>
    <div className="flex items-center justify-between">
      <div className="flex items-center space-x-3">
...
const StatusIndicator = ({isComplete, type}) => (
  <div
    className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-500 ${
      isComplete ? (type === "burn" ? "bg-orange-600 scale-110 animate-pulse" : "bg-green-600 scale-110") : "bg-gray-400"
    }`}>
